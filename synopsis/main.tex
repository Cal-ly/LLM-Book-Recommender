...
% Glossaries
\include{appendix/a-glossary}
\include{appendix/b-symbols}
\include{appendix/c-figures}

% Theoretical Appendices
\include{appendix/d-sentence-embeddings}
\include{appendix/e-zero-shot}
\include{appendix/f-faiss}
\include{appendix/g-confidence-filtering}
\include{appendix/h-keyword-fallback}
