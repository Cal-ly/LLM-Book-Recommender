...
\input{main/3dataset}
\input{main/4embedding}
\input{main/5similarity}
\input{main/6interface}
\input{main/7performance}
\input{main/8conclusion}
...
\appendix
\input{appendix/a-symbols}
\input{appendix/b-math-theory}
\input{appendix/c-ml-theory}
