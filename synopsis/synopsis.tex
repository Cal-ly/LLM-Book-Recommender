...
\input{main/3dataset}
\input{main/4category-inference}
...
% Glossaries
\include{appendix/appendix-symbols}
\include{appendix/appendix-glossary}

% Theoretical Appendices
\include{appendix/appendix-sentence-embeddings}
\include{appendix/appendix-zero-shot}
\include{appendix/appendix-faiss}
\include{appendix/appendix-confidence-filtering}
\include{appendix/appendix-keyword-fallback}
\include{appendix/appendix-semantic-vs-keyword}
